...
# Sequential 모델을 함수형 모델로 바꿔보기 - 보스턴 주택 가격
# 1. 데이터
...
import glob, os
files = sorted(glob.glob(save_path + 'k34_' + date + '03_boston_*.keras'))
for f in files[:-1]:
    os.remove(f)
...
loss :  25.083436965942383
r2 :  0.6986752039263566
mse :  25.083435679614023
RMSE :  5.0083366180413655
'''