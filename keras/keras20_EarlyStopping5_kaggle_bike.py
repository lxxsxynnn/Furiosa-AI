...
es = EarlyStopping(
    monitor='val_loss',
    mode='min',
    patience=20,        # epochs(200)의 10% - 너무 크면 EarlyStopping이 걸리지 않음
...
plt.plot(hist.history['loss'], c='pink', label='loss')
plt.plot(hist.history['val_loss'], c='brown', label='val_loss')
