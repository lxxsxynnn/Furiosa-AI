...
es = EarlyStopping(
    monitor='val_loss',
    mode='min',
    patience=50,        # epochs(500)의 10% - 너무 크면 EarlyStopping이 걸리지 않음
...
print("r2: ", r2)       # r2:  0.6006615662705466

mse = mean_squared_error(y_test, y_predict)
print("mse: ", mse)     # mse:  2731.6495817535456

def RMSE(y_test, y_predict):  # RMSE 함수 정의
    return np.sqrt(mean_squared_error(y_test, y_predict))

rmse = RMSE(y_test, y_predict)
print("RMSE : ", rmse)  # RMSE :  52.26518517860188
