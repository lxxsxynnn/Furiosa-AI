...
# Sequential 모델을 함수형 모델로 바꿔보기 - 당뇨
# 1. 데이터
...
import glob, os
files = sorted(glob.glob(save_path + 'k34_' + date + '02_diabetes_*.keras'))
for f in files[:-1]:
    os.remove(f)
...
loss :  3835.3330078125
r2 :  0.24894224322857827
mse :  3835.3332168947013
RMSE :  61.930067147506804
'''