...
print('loss : ', result[0])             # loss :  0.25401097536087036
print('acc : ', round(result[1], 2))    # acc :  0.9
...
print('acc_score : ', accuracy_score)           # acc_score :  0.8998562859822896
print('time : ', round(end - start, 2), 'sec')  # time :  339.34 sec