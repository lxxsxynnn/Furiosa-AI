...
# 증폭한 데이터랑 합치기
# x_augmented는 flow에 넣기 전의 원본이므로 증폭을 거친 xy_augmented를 붙임
...
mcp = ModelCheckpoint(
    ...
    mode='min',
    save_best_only=True,
    filepath=path + 'keras52_12_fashion.keras'
)
...
print('loss : ', loss[0])                                   # loss : 0.22093379497528076 > 0.29148000478744507
print('acc : ', loss[1])                                    # acc : 0.9241999983787537 > 0.892799973487854
...
print('accuarcy_score : ', acc_score)                       # accuracy_score : 0.9242 > 0.8928
print('time : ', round(end_time - start_time, 2), 'sec')    # time : 275.29 sec > 474.38 sec